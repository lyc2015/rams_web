        ...
        axios
          ...
          .then((result) => {
            mailText +=
              ...
              (result.data[0].siteRoleName === null ||
...
【年　　齢】：`
        : "") +
      (this.state.age !== null && this.state.age !== "" ? this.state.age : "") +
...
【最寄り駅】：`
        : "") +
      (this.state.nearestStation !== "" && this.state.nearestStation !== null
        ? this.state.stations.find((v) => v.code === this.state.nearestStation)
            .name
        : "") +
          ...
          <Col sm={6}>
            <div style={{ float: "right" }}>
              ...
              <Button
                ...
                variant="info"
                disabled={
                  this.state.sendLetterButtonDisFlag ||
