...
class masterUpdate extends Component {
      ...
      () => {
        axios
          .post(this.state.serverIP + "masterUpdate/getMasterInfo", {
            master: publicUtils.labelGetValue(
              $("#master").val(),
  ...
  update = () => {
    ...
    axios
      .post(this.state.serverIP + "masterUpdate/update", masterModel)
      .then((result) => {
  ...
  delete = () => {
    ...
    if (a) {
      ...
      axios
        .post(this.state.serverIP + "masterUpdate/delete", masterModel)
        .then((result) => {
          if (result.data) {
            this.setState({
              myToastShow: true,
      ...
      <div className="container col-7">
        <div style={{ display: this.state.myToastShow ? "block" : "none" }}>
          <MyToast
            ...
            message={this.state.method === "put" ? "修正成功！" : "削除成功！"}
            type={"success"}
          />
        </div>
        <div
          ...
          {master === "TOPお客様" ? (
            <div>
              ...
              >
                ...
                <TableHeaderColumn
                  dataField="topCustomerAbbreviation"
                  hidden={true}
                ></TableHeaderColumn>
                <TableHeaderColumn
                  dataField="url"
