...
【単　　価】：`:"")+ (this.state.unitPrice !== "" && this.state.unitPrice !== null?(this.state.unitPrice.length>3 ? (this.state.unitPrice / 100000).toFixed(0) : this.state.unitPrice):"") +
