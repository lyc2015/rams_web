...
class siteSearch extends Component {
  ...
  siteSearch = (sendValue) => {
    ...
    SiteSearchModel["admissionStartDate"] = publicUtils.formateDate(
      this.state.admissionStartDate,
      true
    );
    SiteSearchModel["admissionEndDate"] = publicUtils.formateDate(
      this.state.admissionEndDate,
      true
    );
    SiteSearchModel["scheduledEndDate"] = publicUtils.formateDate(
          ...
          <Form id="siteForm">
            ...
            <Form.Group>
                      ...
                      renderInput={(params) => (
                        <div ref={params.InputProps.ref}>
                          <input
                            ...
                            type="text"
                            {...params.inputProps}
                            className="auto form-control Autocompletestyle-siteInfoSearch-topCustomer"
                          />
                        </div>
                      )}
                    />
                ...
                <Col sm={3}>
                  <InputGroup size="sm" className="mb-3 flexWrapNoWrap">
                    ...
                    <Autocomplete
                      ...
                      value={
                        this.state.customerMaster.find(
                          (v) => v.code === this.state.bpCustomerNo
                        ) || {}
                      }
                      onChange={(event, values) =>
                        this.getBpCustomer(event, values)
                      }
                      options={this.state.customerMaster}
                      ...
                      renderInput={(params) => (
                        <div ref={params.InputProps.ref}>
                          <input
                            ...
                            type="text"
                            {...params.inputProps}
                            className="auto form-control Autocompletestyle-siteInfoSearch-bpCustomerNo"
                          />
                        </div>
                      )}
                    />
                      ...
                      renderInput={(params) => (
                        <div ref={params.InputProps.ref}>
                          <input
                            ...
                            type="text"
                            {...params.inputProps}
                            className="auto form-control Autocompletestyle-siteInfoSearch-station"
                          />
                        </div>
                      )}
                    />
                      ...
                      renderInput={(params) => (
                        <div ref={params.InputProps.ref}>
                          <input
                            ...
                            type="text"
                            {...params.inputProps}
                            className="auto form-control Autocompletestyle-siteInfoSearch-developLanguageCode"
                          />
                        </div>
                      )}
                    />
              ...
              <Row>
                ...
                <Col sm={3}>
                  <InputGroup size="sm" className="mb-3">
                    ...
                    <Form.Control
                      ...
                      autoComplete="off"
                      disabled={payOffRange1 === "0" ? true : false}
                    >
                      {this.state.payOffRangeStatus.map((data) => (
                        <option key={data.code} value={data.code}>
                          {data.name}
                ...
                <Col sm={3}>
                  <InputGroup size="sm" className="mb-3">
                    ...
                    <Form.Control
                      as="select"
                      id="dataAcquisitionPeriod"
                      name="dataAcquisitionPeriod"
                      value={dataAcquisitionPeriod}
              ...
              <div style={{ textAlign: "center" }}>
                <Button
                  size="sm"
                  onClick={this.siteSearch.bind(this, null)}
                  variant="info"
                  id="toroku"
                  type="button"
                  color={{ background: "#5599FF" }}
                >
