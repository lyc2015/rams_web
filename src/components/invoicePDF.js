...
class invoicePDF extends React.Component {
  ...
  deleteAll = () => {
    ...
    if (a) {
      ...
      axios
        .post(this.state.serverIP + "sendInvoice/deleteInvoiceDataAll", model)
        .then((result) => {
          if (result.data) {
  ...
  updateRow = () => {
    ...
    if (flag) {
      axios
        .post(this.state.serverIP + "sendInvoice/updateInvoiceData", model)
        .then((result) => {
          if (result.data) {
  ...
  updateAll = () => {
    ...
    axios
      .post(this.state.serverIP + "sendInvoice/updateAllInvoiceData", model)
      .then((result) => {
        if (result.data) {
        ...
        <div>
          <Row>
            <Col sm={12}>
              ...
              <Button size="sm" variant="info" onClick={this.deleteAll}>
                {"すべて削除"}
              </Button>{" "}
              <div style={{ float: "right" }}>
                <Button
        ...
        <Row>
          ...
          <Col sm={2}>
            ...
            <InputGroup size="sm" className="mb-2">
              ...
              <Form.Control
                type="text"
                value={this.state.consumptionTax}
                name="consumptionTax"
                autoComplete="off"
                size="sm"
                disabled
            ...
            <InputGroup size="sm" className="mb-2">
              ...
              <Form.Control
                type="text"
                value={this.state.subTotalAmountTax}
