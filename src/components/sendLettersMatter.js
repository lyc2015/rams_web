...
class sendLettersMatter extends React.Component {
  ...
  componentDidMount() {
    ...
    if (
      ...
      if (
        this.props.location.state.projectNo !== null &&
        this.props.location.state.projectNo !== undefined &&
        this.props.location.state.projectNo !== ""
      ) {
        ...
        axios
          .post(
            this.state.serverIP + "projectInfoSearch/search",
            projectInfoModel
          )
          .then((result) => {
            if (
              ...
              if (
                result.data.projectInfoList[0].payOffRangeLowest !==
                  undefined &&
                result.data.projectInfoList[0].payOffRangeLowest !== null &&
                result.data.projectInfoList[0].payOffRangeHighest !==
                  undefined &&
                result.data.projectInfoList[0].payOffRangeHighest !== null
              ) {
                payOffRange =
                  (result.data.projectInfoList[0].payOffRangeLowest === "0"
                    ? "固定"
                    : result.data.projectInfoList[0].payOffRangeLowest) +
                  "-" +
                  (result.data.projectInfoList[0].payOffRangeHighest === "0"
                    ? "固定"
                    : result.data.projectInfoList[0].payOffRangeHighest);
              }
              ...
              if (
                (result.data.projectInfoList[0].unitPriceRangeLowest !==
                  undefined &&
                  result.data.projectInfoList[0].unitPriceRangeLowest !==
                    null &&
                  result.data.projectInfoList[0].unitPriceRangeLowest !== "") ||
                (result.data.projectInfoList[0].unitPriceRangeHighest !==
                  undefined &&
                  result.data.projectInfoList[0].unitPriceRangeHighest !==
                    null &&
                  result.data.projectInfoList[0].unitPriceRangeHighest !== "")
              ...
              if (
                result.data.projectInfoList[0].projectPhaseStart !==
                  undefined &&
                result.data.projectInfoList[0].projectPhaseStart !== null &&
                result.data.projectInfoList[0].projectPhaseStart !== ""
              ) {
                projectPhase =
                  result.data.projectInfoList[0].projectPhaseNameStart;
              }
              if (
                result.data.projectInfoList[0].projectPhaseNameEnd !==
                  undefined &&
                result.data.projectInfoList[0].projectPhaseNameEnd !== null &&
                result.data.projectInfoList[0].projectPhaseNameEnd !== ""
              ) {
                projectPhase =
              ...
              if (
                result.data.projectInfoList[0].keyWordOfLanagurueName1 !==
                  undefined &&
                result.data.projectInfoList[0].keyWordOfLanagurueName1 !==
                  null &&
                result.data.projectInfoList[0].keyWordOfLanagurueName1 !== ""
              ...
              if (
                result.data.projectInfoList[0].keyWordOfLanagurueName2 !==
                  undefined &&
                result.data.projectInfoList[0].keyWordOfLanagurueName2 !==
                  null &&
                result.data.projectInfoList[0].keyWordOfLanagurueName2 !== ""
              ...
              if (
                result.data.projectInfoList[0].keyWordOfLanagurueName3 !==
                  undefined &&
                result.data.projectInfoList[0].keyWordOfLanagurueName3 !==
                  null &&
                result.data.projectInfoList[0].keyWordOfLanagurueName3 !== ""
              ...
              if (keyWordOfLanagurueName.length > 0) {
                keyWordOfLanagurueName = keyWordOfLanagurueName.substring(
                  0,
                  keyWordOfLanagurueName.lastIndexOf(",")
                );
              }
              this.setState({
                matterText:
                  ...
                  (unitPriceRange === ""
                    ...
                    : "\n■月額単金：" + unitPriceRange) +
                  (payOffRange === "" ? "" : "\n■清算範囲：" + payOffRange) +
                  (result.data.projectInfoList[0].recruitmentNumbers === null ||
                  result.data.projectInfoList[0].recruitmentNumbers === ""
                    ? ""
                    : "\n■募集人数：" +
                      (result.data.projectInfoList[0].recruitmentNumbers ===
                      null
                        ? ""
                        : result.data.projectInfoList[0].recruitmentNumbers)) +
                  ((result.data.projectInfoList[0].admissionPeriod === null ||
                    result.data.projectInfoList[0].admissionPeriod === "") &&
                  (result.data.projectInfoList[0].projectPeriodName === null ||
                    result.data.projectInfoList[0].projectPeriodName === "")
                    ? ""
                    : "\n■稼動時期：" +
                      result.data.projectInfoList[0].admissionPeriod +
                      "～" +
                      result.data.projectInfoList[0].projectPeriodName) +
                  (result.data.projectInfoList[0].siteLocationName === null ||
                  result.data.projectInfoList[0].siteLocationName === ""
                    ? ""
                    : "\n■勤務地：" +
                      (result.data.projectInfoList[0].siteLocationName === null
                        ? ""
                        : result.data.projectInfoList[0].siteLocationName)) +
                  (projectPhase === "" ? "" : "\n■作業工程：" + projectPhase) +
                  (result.data.projectInfoList[0].nationalityName === null ||
                  result.data.projectInfoList[0].nationalityName === ""
                    ? ""
                    : "\n■国籍：" +
                      (result.data.projectInfoList[0].nationalityName === null
                        ? ""
                        : result.data.projectInfoList[0].nationalityName +
                          (result.data.projectInfoList[0]
                          ...
                          result.data.projectInfoList[0]
                            ...
                            : "、" +
                              result.data.projectInfoList[0]
                                .japaneaseConversationName))) +
                  (result.data.projectInfoList[0].noOfInterviewName === null ||
                  result.data.projectInfoList[0].noOfInterviewName === ""
                    ? ""
                    : "\n■面談回数：" +
                      (result.data.projectInfoList[0].noOfInterviewName === null
                        ? ""
                        : result.data.projectInfoList[0].noOfInterviewName)) +
                  (result.data.projectInfoList[0].remark === null ||
                  result.data.projectInfoList[0].remark === ""
                    ? ""
                    : "\n■備考：" +
                      (result.data.projectInfoList[0].remark === null
                        ? ""
          ...
          <Col sm={6}>
            <div style={{ float: "right" }}>
              <Button
                ...
                variant="info"
                name="clickButton"
                disabled={this.state.selectRow1Flag ? false : true}
              >
              ...
              <Button
                ...
                variant="info"
                disabled={
                  this.state.mailTitle === "" || this.state.sendLetterOverFlag
                    ? true
                    : false
                }
              >
