...
class salesAppend extends Component {
  initialState = {
    ...
    allSalesPersons: [],
    selectetRowIds:
      this.props.customer.test !== undefined &&
      this.props.customer.test !== "" &&
      this.props.customer.test !== null
        ? this.props.customer.test.split(",")
        : this.props.customer.mainChargeList !== undefined &&
          this.props.customer.mainChargeList !== "" &&
          this.props.customer.mainChargeList !== null
        ? this.props.customer.mainChargeList.split(",")
        : [],
    selectetPersonsName:
  ...
  getSalesPersons = (customerNo) => {
    axios
      .post(this.state.serverIP + "salesSendLetters/getSalesPersons", {
  ...
  handleRowSelect = (row, isSelected, e) => {
    if (isSelected) {
      this.setState({
        ...
        selectetPersonsName: this.state.selectetPersonsName.concat([
      ...
      index = this.state.selectetPersonsName.findIndex(
  ...
  salesSelected = () => {
    ...
    if (
      ...
      axios
        .post(
          this.state.serverIP +
            "salesSendLetters/customerSendMailStorageListUpdate",
          {
      ...
      <div>
        ...
        <div style={{ marginLeft: "15px", marginRight: "15px" }}>
          ...
          >
            ...
            <TableHeaderColumn width="9%" dataField="responsiblePerson">
              名前
            </TableHeaderColumn>
