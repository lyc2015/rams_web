      ...
      .then((data) => {
        this.setState({
          ...
          temporary_age:
            publicUtils.converToLocalTime(data.birthday, true) === ""
              ...
              : Math.ceil(
                  (new Date().getTime() -
                    publicUtils
                      .converToLocalTime(data.birthday, true)
                      .getTime()) /
                    31536000000
                ),
          ...
          retirementYearAndMonthDisabled:
            data.employeeFormCode === "3" ? true : false,
          occupationCode: data.occupationCode, // 職種
          departmentCode: data.departmentCode, // 部署
          companyMail:
            data.companyMail !== null &&
            data.companyMail !== "" &&
            data.companyMail !== undefined
          ...
          temporary_intoCompanyYearAndMonth: publicUtils.getFullYearMonth(
            publicUtils.converToLocalTime(data.intoCompanyYearAndMonth, false),
            new Date()
          ),
          ...
          temporary_contractDeadline:
            publicUtils.converToLocalTime(data.contractDeadline, false) === ""
              ? ""
              : publicUtils.getFullYearMonth(
                  new Date(),
                  publicUtils.converToLocalTime(data.contractDeadline, false)
            ...
            <Row>
              ...
              <Col sm={3}>
                ...
                >
                  ...
                  <FormControl size="sm" name="alphabetName" disabled />
                </InputGroup>
                <InputGroup size="sm" className="mb-3">
                  <InputGroup.Prepend>
                    <InputGroup.Text id="inputGroup-sizing-sm">
              ...
              <Col sm={3}>
                <InputGroup size="sm" className="mb-3">
                  ...
                  <FormControl
                    ...
                    disabled
                  />
                  <FormControl value={major} size="sm" name="major" disabled />
                </InputGroup>
              </Col>
              <Col sm={3}>
                <InputGroup size="sm" className="mb-3">
              ...
              <Col sm={5}>
                <InputGroup size="sm" className="mb-3">
                  ...
                  <Button size="sm" disabled>
                    <FontAwesomeIcon icon={faFile} />{" "}
                    {this.state.resumeInfo1URL !== "" ? " 済み" : " 添付"}
                  </Button>
                  <FormControl
                    value={resumeName1}
                    autoComplete="off"
                  ...
                  <Button size="sm" disabled>
                    <FontAwesomeIcon icon={faFile} />{" "}
                    {this.state.resumeInfo2URL !== "" ? " 済み" : " 添付"}
                  </Button>
                  <FormControl
                    value={resumeName2}
                    autoComplete="off"
