...
class IndividualCustomerSales extends React.Component {
  ...
  handleTag = (event, values) => {
    if (
      ...
      (this.state.individualCustomerSales_startYearAndMonth !== "" &&
        this.state.individualCustomerSales_endYearAndMonth !== "")
    ) {
      if (values != null) {
        this.setState(
          {
  ...
  searchCustomer = () => {
    const customerInfo = {
      ...
      startYear: publicUtils.formateDate(
        this.state.individualCustomerSales_startYearAndMonth,
        false
      ),
      endYear: publicUtils.formateDate(
        this.state.individualCustomerSales_endYearAndMonth,
        false
      ),
    };
    ...
    axios
      ...
      .then((response) => {
        if (response.data.errorsMessage != null) {
          ...
          this.setState({
            totalworkPeoSum:
              this.state.CustomerSaleslListInfoList[0].totalworkPeoSum,
          });
          this.setState({
            totaluPrice: publicUtils.addComma(
              this.state.CustomerSaleslListInfoList[0].totaluPrice,
              false
            ),
          });
          this.setState({
            overTimeOrExpectFee: publicUtils.addComma(
              this.state.CustomerSaleslListInfoList[0].overTimeOrExpectFee,
              false
            ),
          });
          this.setState({
          ...
          <Col sm={3}>
            <InputGroup size="sm" className="flexWrapNoWrap">
              ...
              <Autocomplete
                ...
                value={
                  customerInfo.find(
                    (v) => v.code === this.state.customerName
                  ) || {}
                }
        ...
        <Row style={{ marginTop: "15px" }}>
          <Col sm={3}>
            <InputGroup size="sm">
              ...
              <FormControl value={totalworkPeoSum} disabled />
            </InputGroup>
          </Col>
          ...
          <Col sm={3}>
            <InputGroup size="sm">
              ...
              <FormControl value={totaluPrice} disabled />
            </InputGroup>
          </Col>
          <Col sm={3}>
            <InputGroup size="sm">
        ...
        <Col>
          ...
          >
            ...
            <TableHeaderColumn
              tdStyle={{ padding: ".45em" }}
              width="125"
              dataField="maxUnitPrice"
              dataFormat={this.maxUnitPriceFormat}
            >
              最高単価
            </TableHeaderColumn>
            <TableHeaderColumn
              tdStyle={{ padding: ".45em" }}
              dataField="minUnitPrice"
              dataFormat={this.minUnitPriceFormat}
            >
              最低単価
            </TableHeaderColumn>
            <TableHeaderColumn
            ...
            <TableHeaderColumn
              tdStyle={{ padding: ".45em" }}
              dataField="workPeoSum"
              dataFormat={this.workPeoSumFormat}
              width="90"
            >
              稼働人数
            </TableHeaderColumn>
            ...
            <TableHeaderColumn
              tdStyle={{ padding: ".45em" }}
              dataField="overTimeFee"
              dataFormat={this.overTimeFeeAddComma}
            >
              残業代
            </TableHeaderColumn>
            <TableHeaderColumn
              ...
              width="125"
              dataField="expectFee"
              dataFormat={this.expectFeeAddComma}
            >
              控除
            </TableHeaderColumn>
            <TableHeaderColumn
              ...
              dataFormat={this.totalAmountAddComma}
            >
              費用
            </TableHeaderColumn>
            <TableHeaderColumn
              ...
              dataFormat={this.grossProfitAddComma}
            >
              粗利
            </TableHeaderColumn>
          </BootstrapTable>
