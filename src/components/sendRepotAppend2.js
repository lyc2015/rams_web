      ...
      <div>
        ...
        <div>
          <BootstrapTable
            ...
            condensed
          >
            <TableHeaderColumn width="7%" dataField="employeeName" isKey>
              氏名
            </TableHeaderColumn>
            <TableHeaderColumn width="11%" dataField="bpOrLyc">
              所属
            </TableHeaderColumn>
            <TableHeaderColumn width="9%" dataField="positionCode">
              現場
            </TableHeaderColumn>
            <TableHeaderColumn width="9%" dataField="approvalStatus">
              承認済み
            </TableHeaderColumn>
            <TableHeaderColumn width="20%" dataField="sentReportStatus">
              送信済み
            </TableHeaderColumn>
          </BootstrapTable>
        </div>
