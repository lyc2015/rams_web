...
class employeeInsert extends React.Component {
  ...
  initialState = {
    ...
    image:
      "https://images.669pic.com/element_pic/54/25/82/94/d2825498dd97a2594c35d633e8454d19.jpg_w700wb",
    myToastShow: false,
  ...
  insertEmployee = (event) => {
    ...
    const emp = {
      ...
      intoCompanyYearAndMonth:
        this.state.employeeStatus === "0"
          ? publicUtils.formateDate(this.state.intoCompanyYearAndMonth, false)
          : " ", // 入社年月
    ...
    axios
      .post(this.state.serverIP + "employee/insertEmployee", formData)
      .then((result) => {
  ...
  inactiveGraduationYearAndMonth = (date) => {
    this.setState({
      ...
      temporary_yearsOfExperience:
        this.state.yearsOfExperience === undefined
  ...
  valueChangeResidenceCodeFormCode = (event) => {
    ...
    if (value === "5") {
      this.setState({
        ...
        stayPeriod: "",
        residenceCode: event.target.value,
  ...
  render() {
    const {
      ...
      employeeStatus,
      stationCodeValue,
      developLanguage1Value,
      developLanguage2Value,
      developLanguage3Value,
      developLanguage4Value,
      developLanguage5Value,
    } = this.state;
                  ...
                  <Autocomplete
                    ...
                    renderInput={(params) => (
                      <div ref={params.InputProps.ref}>
                        <Button
                          size="sm"
                          className="auto form-control Autocompletestyle-employeeInsert-upload"
                          onClick={(event) =>
              ...
              <Col sm={2}>
                <InputGroup size="sm" className="mb-3">
                  ...
                  <Form.File
                    ...
                    custom
                    onChange={(event) => this.changeFile(event, "passportInfo")}
                  />
                </InputGroup>
              </Col>
              ...
              <Col sm={5}>
                <InputGroup size="sm" className="mb-3">
                  ...
                  <FormControl
                    ...
                    autoComplete="off"
                    maxlength="30"
                    id="Autocompletestyle-employeeInsert-resumeInfo"
                    onChange={this.valueChange}
                    size="sm"
                    name="resumeName1"
                  />
                  ...
                  <Form.File
                    ...
                    custom
                    onChange={(event) => this.changeFile(event, "resumeInfo2")}
                  />
                </InputGroup>
              </Col>
              <Col sm={3}>
